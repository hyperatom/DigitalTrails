...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	private ArrayList<Integer> getLocationIDsForWalkID(int walkID) {
		 ArrayList<Integer> idList = new ArrayList<Integer>();
		    // Select All Query
		    String selectQuery = "SELECT  * FROM " + TABLE_PLACES + " WHERE walkId="+walkID;
	...
	public WalkPoint getWalkPoint(int walkPointID,int walkID) { //this is the locationID (unique&global)
		
		    // Select All Query
		    String selectQuery = "SELECT  * FROM " + TABLE_LOCATIONS + " WHERE id="+walkPointID;
		    ...
		    if (cursor != null)
		        cursor.moveToFirst();
		 //new WalkPoint(0, 52.41630256175995,-4.065622687339783,  "Astute Office", "This is the Astute office...")
		    WalkPoint walkPoint = new WalkPoint(Integer.parseInt(cursor.getString(0)),Double.parseDouble(cursor.getString(3)),Double.parseDouble(cursor.getString(4)),cursor.getString(1),cursor.getString(5));
	...
	public Walk getWalkID(int walkID) {
		 String selectQuery = "SELECT  * FROM " + TABLE_WALKS + " where id ="+walkID;
		    ...
		    if (cursor!=null)
		    	cursor.moveToFirst();
		        	...
		        	//0=id, 1=titleEng, 2=titleWelsh, 3=shortWelshDesc, 4=shortEngDesc, 5=engDesc, 6=welshDesc
		            Walk walk = new Walk();
	...
	public ArrayList<WalkPoint> getWalkPointsForWalkID(int walkID) {
	 ...
	 /*
	 public ArrayList<WalkPoint> getAllPoints() {
		 ArrayList<WalkPoint> walkPointList = new ArrayList<WalkPoint>();
		    // Select All Query
		    ...
		    if (cursor.moveToFirst()) {
		        do {
		            ...
		            walkPointList.add(walkPoint);
		        } while (cursor.moveToNext());
		    }
		 
		    // return contact list
		    cursor.close();
		    return walkPointList;
	 }
	 */
	 
	 private int getPlaceIdForPoint(int pointID, int walkID) {
		 String selectQuery = "SELECT id FROM places WHERE locationId ="+pointID+" and walkId= "+walkID;
